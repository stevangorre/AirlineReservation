...
public class BookingInfoBean {
	...
	public String toString() {
		return "BookingInfoBean [flightNo=" + flightNo + ", bookingId="
				+ bookingId + ", custEmail=" + custEmail + ", numOfPass="
				+ numOfPass + ", classType=" + classType + ", totalFare="
				+ totalFare + ", seatNumbers=" + seatNumbers + ", cardInfo="
				+ cardInfo + ", depCity=" + depCity + ", arrCity=" + arrCity
				+ ", depDate=" + depDate + "]";
	}
